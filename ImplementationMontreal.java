...
//                    for (int i = 0; i < customerBooking.size(); i++) {
    ...
    public String listEventAvailability(String eventType)  {
        ...
        if (exists) {
            ...
            reply = "NO SUCH EVENT TYPE FOUND ON MONTREAL SERVER";
...
//Ottawa
    ...
    public String listEventAvailabilityServerCall(String eventType)  {
...
//    }
    ...
    public String getBookingSchedule(String customerId)  {
        ...
        if (customerBooking.containsKey(customerId)) {
            ...
            reply = "NO SUCH CUSTOMER FOUND FOUND ON MONTREAL SERVER";
        }
//        Ottawa
...
//        Toronto
    ...
    public String getBookingScheduleServerCall(String customerId)  {
        ...
        if (customerBooking.containsKey(customerId)) {
            ...
            reply = "NO SUCH CUSTOMER FOUND ON MONTREAL";
            LogData("Get Booking Schedule : NO SUCH CUSTOMER FOUND \n");
        }
        return reply;
    }
    ...
    public void LogData(String value) {
        ...
        File log = new File("MontrealLog.txt");
        try {
            if (!log.exists()) {
